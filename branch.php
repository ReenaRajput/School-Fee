...
$brnch = mysqli_real_escape_string($conn,$_POST['branch']);
...
$detail = mysqli_real_escape_string($conn,$_POST['detail']);
 ...
 if($_POST['action']=="add")
 {
  ...
  $sql = $conn->query("INSERT INTO branch (brnch,address,detail) VALUES ('$brnch','$address','$detail')") ;
 ...
 $id = mysqli_real_escape_string($conn,$_POST['id']);	
   $sql = $conn->query("UPDATE  branch  SET  branch  = '$brnch', address  = '$address', detail  = '$detail'  WHERE  id  = '$id'");
