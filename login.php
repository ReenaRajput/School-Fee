...
$usernam =  mysqli_real_escape_string($conn,trim($_POST['username']));
...
$sql = "select * from user where username='".$usernam."' and password = '".md5($pasword)."'";

$q = $conn->query($sql);
if($q->num_rows==1)
{
$res = $q->fetch_assoc();
$_SESSION['raibow_username']=$res['username'];
$_SESSION['rainow_uid']=$res['id'];
$_SESSION['rainow_name']=$res['name'];
         ...
         <div class="row ">
                ...
                <div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3 col-xs-10 col-xs-offset-1">
                            ...
                            <div class="panel-body" style="background-color: #E2E2E2; margin-top:50px; border:solid 3px #0e0e0e;">
							  <h3 class="myhead">Payment System</h3>
